...
// /buiten/[slug]/[categorySlug] — a normal category page (same
// CategoryListingPage as /categorie/[slug]), reached via its Outdoor Parent
// Category. 404s if the category isn't actually assigned to that parent.
export default function AussenParentCategoryDetailPage() {
  ...
  return (
    <CategoryListingPage
      ...
      parentCategoryHref={`/buiten/${encodeURIComponent(parent.slug)}`}
    />
  );
}
