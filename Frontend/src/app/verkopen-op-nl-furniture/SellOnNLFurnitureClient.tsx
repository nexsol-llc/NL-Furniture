...
// src/app/verkopen-op-nl-furniture/SellOnNLFurnitureClient.tsx
...
export default function SellOnNLFurnitureClient() {
  const { t } = useLanguage();
  return (
    <main className="min-h-screen bg-white text-gray-900">
      {/* Hero Section mit Hintergrundbild */}
      <section className="relative -mt-[var(--header-height)] py-20 sm:py-32 overflow-hidden min-h-[85vh] flex items-center">
        {/* Hintergrundbild */}
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900/70 via-gray-900/60 to-transparent" />
        </div>

        <Reveal className="relative max-w-content mx-auto px-6 sm:px-12 text-center text-white z-10">
          ...
          <Link
            href="#form"
            className="inline-block bg-white text-black font-bold px-10 py-5 rounded-full text-xl hover:bg-gray-100 transition-all shadow-soft-lg"
          >
