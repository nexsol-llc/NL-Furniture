...
export default function CategoryCardsGrid({
  ...
  return (
    <>
      <div className="hidden md:grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7 gap-4">
        {categories.map((cat) => (
          <Link
            key={cat.slug}
          ...
          >
            <div className="w-24 h-24 sm:w-28 sm:h-28 bg-white shadow-soft group-hover:shadow-soft-lg transition-all flex items-center justify-center overflow-hidden rounded-2xl">
      ...
      <div className="md:hidden">
        <div className="flex gap-4 overflow-x-auto pb-6 snap-x snap-mandatory scrollbar-hide">
          {categories.map((cat) => (
            ...
            >
              <div className="w-24 h-24 bg-white shadow-soft group-hover:shadow-soft-lg transition-all flex items-center justify-center overflow-hidden rounded-2xl">
