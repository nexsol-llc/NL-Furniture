  ...
  return (
    <section className={`max-w-content mx-auto px-4 py-8 ${className}`}>
      <div className="bg-white rounded-2xl border border-gray-200 shadow-soft-md p-6 md:p-10">
        ...
        <div
          className="prose prose-sm md:prose-base max-w-none text-gray-700 [&_h2]:text-h2 [&_h2]:text-gray-900 [&_h3]:text-h3 [&_h3]:text-gray-900 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-6"
